...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="#page-top">E-Perpusda</a>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="team-member">
                            ...
                            <h4>Yusuf Bagus Sungging H.</h4>
                            <p class="text-muted">V3420077</p>
                    ...
                    <div class="col-lg-4">
                        <div class="team-member">
                            ...
                            <h4>Ridho Fata' Ulwan</h4>
                            <p class="text-muted">V3420061</p>
                    ...
                    <div class="col-lg-4">
                        <div class="team-member">
                            ...
                            <h4>Sinta Athaya Ramadhani</h4>
                            <p class="text-muted">V3420072</p>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <div class="team-member">
                            ...
                            <h4>Saka Pangestu Putra</h4>
                            <p class="text-muted">V3420080</p>
                    ...
                    <div class="col-lg-5">
                        <div class="team-member">
                            ...
                            <h4>Umar Syaifulloh</h4>
                            <p class="text-muted">V3420074</p>
                            <p class="text-muted">Testing and Documentation</p>
                        </div>
                    </div>
                </div>
            </div>
